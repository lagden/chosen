...
"""
    minified_comments: [
      "/* Chosen #{version_tag()}"
      "| (c) 2011-<%= grunt.template.today('yyyy') %> by Harvest"
      "| MIT License, "
  ...
  grunt.registerTask 'prep_release', [
    'build'
    'dom_munger:latest_version'
    'zip:chosen'
    'package_jquery'
  ]

  grunt.registerTask 'package_jquery',
    'Generate a jquery.json manifest file from package.json',
    () ->
      src = "package.json"
